package edu.uthouston.sbmi.hootation.triple2nl;
...
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.FRAGMENT;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.S;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.SBAR;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.SBARQ;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.SINV;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.VERB_PHRASE;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.DETERMINER;
import static edu.uthouston.sbmi.hootation.util.PennTreebankTagSet.NOUN_PHRASE;
import edu.uthouston.sbmi.hootation.util.Preposition;
...
public class PropertyVerbalizer {
    ...
    public PropertyVerbalization verbalize(String propertyURI){
		...
		//System.out.println("property text:.... " + propertyText);
    	...
    	//System.out.println("\nProperty verbalization: \n" + propertyVerbalization.toString()+ "\nEnd Property verbalization\n");
    ...
    public PropertyVerbalization verbalize(String propertyURI, String label){
		...
		//get textual representation for the property URI
		String propertyText = label;
    		if(propertyText.trim() == ""){
    			propertyText = uriConverter.convert(propertyURI);
    		}
		//normalize the text, e.g. to lower case
		propertyText = normalize(propertyText);
...
//			tree.pennPrint();
	...
	private String normalize(String propertyText){
		//lower case
		propertyText = propertyText.replaceAll("_", " ");
		propertyText = this.splitCamelCase(propertyText);
